...
public class SecurityToken implements SignToken, Serializable {
    ...
    public SecurityToken(String accessToken, long signAccessTimestamp) {
    ...
    public static class SecurityTokenBuilder {
        ...
        private SecurityTokenBuilder(String token) {
            this.accessToken = token;
        }

        public SecurityToken build() {
            return new SecurityToken(this.accessToken, this.signAccessTimestamp);
        }

        public static SecurityTokenBuilder withAccessToken(String token) {
            return new SecurityTokenBuilder(token);
        }
