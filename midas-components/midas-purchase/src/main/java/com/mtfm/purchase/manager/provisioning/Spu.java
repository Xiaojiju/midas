...
public class Spu implements Serializable {
    ...
    public static class SpuDetails extends Spu {
         ...
         * 属性值
         */
        private List<AttributeGroupValue> spuAttributes;
        /**
         * 包含规格
         */
        ...
        public SpuDetails(Spu spu, List<SpuImage> images, List<AttributeGroupValue> spuAttributes, List<SkuItemGroup> groups) {
            if (spu != null) {
                super.setId(spu.id);
        ...
        public List<AttributeGroupValue> getSpuAttributes() {
            return spuAttributes;
        }

        public void setSpuAttributes(List<AttributeGroupValue> spuAttributes) {
            this.spuAttributes = spuAttributes;
        }
