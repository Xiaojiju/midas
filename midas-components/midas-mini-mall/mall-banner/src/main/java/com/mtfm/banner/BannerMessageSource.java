 ...
 * {@link BannerMessageSource#getAccessor()}进行直接使用spring的国际化；
 */
public class BannerMessageSource extends ResourceBundleMessageSource {

    public BannerMessageSource() {
        addBasenames("i18n/banner_messages");
    }

    public static MessageSourceAccessor getAccessor() {
        return new MessageSourceAccessor(new BannerMessageSource());
    }
}
