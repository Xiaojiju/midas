 ...
 */
@Configuration
public class ExpressDeliveryConfiguration {

    public ExpressDeliveryConfiguration(ResourceBundleMessageSource messageSource) {
        messageSource.addBasenames("i18n/express_messages");
    }

    @Bean
    public DeliveryAddressManager deliveryAddressManager() {
        return new DeliveryAddressManageService();
    }
