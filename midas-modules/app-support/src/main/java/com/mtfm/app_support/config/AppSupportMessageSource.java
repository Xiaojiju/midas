 ...
 * {@link AppSupportMessageSource#getAccessor()}进行直接使用spring的国际化；
 */
public class AppSupportMessageSource extends SolarMessageSource {

    public AppSupportMessageSource() {
        addBasenames("i18n/app_support_messages");
    }

    public static MessageSourceAccessor getAccessor() {
        return new MessageSourceAccessor(new AppSupportMessageSource());
    }
}
