...
public class AppUserAccountManageService extends AppUserDetailsService implements UserDetailsManager, InitializingBean, MessageSourceAware {

    private static final Logger logger = LoggerFactory.getLogger(AppUserAccountManageService.class);
    ...
    public AppUserAccountManageService(AppUserMapper appUserMapper, AppUserReferenceService appUserReferenceService, AppUserSecretService appUserSecretService) {
        super(appUserMapper);
