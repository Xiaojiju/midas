...
public class SolarUserReference extends BaseModel<SolarUserReference> implements Serializable {
    ...
    public SolarUserReference() {
    }

    public SolarUserReference(String id,
                              String identifier,
                              String referenceKey,
                              Judge validated,
                              String afterReferenceKey,
                              LocalDateTime expiredTime,
                              LocalDateTime validatedTime,
                              Judge loginAccess,
                              Judge thirdPart,
                              String uId) {
        this.id = id;
    ...
    public static UserReferenceBuilder builder(SolarUserReference userReference) {
        return new UserReferenceBuilder(userReference);
    }
    ...
    public static class UserReferenceBuilder {
        ...
        private UserReferenceBuilder(SolarUserReference userReference) {
            this.id = userReference.id;
            this.identifier = userReference.identifier;
            this.referenceKey = userReference.referenceKey;
            this.validated = userReference.validated;
            this.afterReferenceKey = userReference.afterReferenceKey;
            this.expiredTime = userReference.expiredTime;
            this.loginAccess = userReference.loginAccess;
            this.thirdPart = userReference.thirdPart;
            this.uId = userReference.uId;
            this.validatedTime = userReference.validatedTime;
        }

        public SolarUserReference build() {
            ...
            Assert.isTrue(StringUtils.hasText(this.identifier), "user reference identifier field could not " +
                    "be null");
            Assert.isTrue(StringUtils.hasText(this.referenceKey), "user reference key field could not be null");
            ...
            return new SolarUserReference(this.id, this.identifier, this.referenceKey, this.validated,
